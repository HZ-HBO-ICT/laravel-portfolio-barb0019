    ...
    <div class="row">
        <div class="leftcolumn">
            <div class="card">
                ...
                <article>
                    <p>Mijn motivatie voor ICT is het feit dat ICT de wereld aan het overnemen is, dus als ik goede
                        kennis heb
                        over
                        ICT
                        in de toekomst betekent dat ook
                        dat mijn toekomst snor zit.
                        Los daarvan is het ook nog is zo dat ik een aanleg heb voor de omgang met elektronische
                        apparaten en de
                        software

                        daarvan.
                        Als ik ergens voor ga dan geef ik ook de volle 100%. ICT is de perfecte opleiding voor mij,
                        omdat ik snel
                        leer
                ...
                <article>
                    <p>Ik houd me veel bezig met software en hardware van elektronische apparaten. Ik ben een groot fan
                        van
                        android.
                        Ik
        ...
        <div class="rightcolumn-index">
            <div class="card-index">
                ...
                <ul class="sidebar-style">
                    ...
                    <br/>
                    <li class="card-github-padding"><a class="sidemenu-color" href="https://github.com/" target="_blank"
