            ...
            <div class="card-faq">
                ...
                <article>
                    ...
                    <p>1. Printen doe je via de site <a class="button-color" href="https://print.hz.nl/">print.hz.nl</a>.
                        Volg
                        vervolgens de instructies die op <a class="button-color" href="https://print.hz.nl/">print.hz.nl</a>
                        staan.
                    </p>
                    <br>
                    <p>2. Verbind je PC met de HZ printer die je nodig hebt. Dit doe je bij instellingen>apparaten>printers
                        &
                        ...
                        worden.</p>
                    <br>
                    <p>3. Als je coronaklachten klachten hebt wordt het sterk aangeraden om zo snel mogelijk een afspraak te
                        maken
                        voor een coronatest. Licht je docenten in over de coronaklachten en zij zorgen ervoor dat de lessen
                        online
                    ...
                    <p>5. Gratis parkeren is mogelijk op het parkeerterrein van PZEM aan de Poelendaelesingel 10 in
                        Middelburg.
                        <br>Dit is op een paar minuten lopen afstand naar de HZ. Het is helaas niet mogelijk om direct bij
                        het
                        HZ-pand
                        te parkeren.
                        <br>Bij het pand zelf zijn wel twee invalideplaatsen en plekken voor HZ-auto's.
                        Let op, parkeer je aan de Poelendaelesingel,<br> dan kun je niet via het tunneltje de HZ bereiken
                        i.v.m. de
