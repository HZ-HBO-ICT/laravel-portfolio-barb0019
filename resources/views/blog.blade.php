        ...
        <div class="leftcolumn">
            <div class="card">
                @foreach($articles as $article)
                    <h2>{{$article->title}}</h2>
                    <p>{{$article->body}}</p>
                    <h3><a href="/blog/{{$article->id}}/edit" style="color: black">edit post: {{$article->id}}</a></h3>
                @endforeach()

                              <h3>  <a href="/blog/create" style="color: black">Post een blog</a> </h3>
                {{--                <h3>  <a href="/blog/edit" style="color: black">edit een blog</a> </h3>--}}
