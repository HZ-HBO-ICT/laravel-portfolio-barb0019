    ...
    <div class="leftcolumn">
        <div class="card">
            ...
            <p>Ik wil graag HBO-ICT studeren, omdat ik de wereld van IT heel interessant vind. In mijn vrije tijd ben ik
                regelmatig bezig met zowel software als hardware. Ik zou graag mijn kennis willen verrijken en waar kan dat
                beter dan op de HZ! ICT neemt tegenwoordig de wereld over. ICT zie je overal terug, dus de vraag naar ICT
                neemt ook toe. Genoeg werk aan de winkel dus voor ICT' ers! Ik wil dus graag deze opleiding doen, zodat ik in
            ...
            <p>Strenghts: Ik ben leergierig. Ik wil dingen niet alleen onthouden maar ook echt begrijpen.
                <br>
                <br>
                Weaknesses: Ik ben soms te leergierig, probeer dingen soms tot de bodem te begrijpen en dat gaat niet altijd.
                ...
                <br>
                <br>
                threats: Omdat ik alles zo goed mogelijk wil begrijpen ben ik bang dat mijn tempo nu nog iets te laag is voor
                het HBO.
            ...
            <h2>Blogposts:</h2>
            <h4> Op 10-09-2021 ben ik op bedrijvensafari geweest! Ik heb verschillende presentaties <br> gevolgd en heb een
